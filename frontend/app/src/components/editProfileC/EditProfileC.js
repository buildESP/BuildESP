...
const EditProfileC = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setFormData({
          ...
          prenom: user.firstname || '',
          email: user.email || '',
          motDePasse: '', // Leave password empty initially
          adresse: user.address || '',
          codePostal: user.postcode || '',
          numeroDeTelephone: user.phone || '',
          rating: user.rating || '',
  ...
  const handleSubmit = (e) => {
    ...
    // Create the updatedData object without the password field initially
    const updatedData = {
      firstname: formData.prenom,
      lastname: formData.nom,
      email: formData.email,
    ...
    // Only add the password field if motDePasse is not empty
    if (formData.motDePasse.trim() !== '') {
      updatedData.password = formData.motDePasse;
    }
