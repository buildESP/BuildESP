...
describe('mentions legales', () => {
    it('should visit the home page, click on the mentions legales button, and assert it', () => {
      ...
      cy.get('[href="/Mention-legales"]').click(); // Click on the "Mentions légales" button
      cy.url().should('include', '/Mention-legales');
